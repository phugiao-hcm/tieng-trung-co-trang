<template>
    <header class="bg-[#191B24] shadow-md sticky top-0 z-50">
        <div
        ...
        >
            ...
            <div class="hidden md:flex items-center space-x-4">
                <nav class="flex space-x-6 font-medium text-white">
                    <NuxtLink
                        to="/"
                        @click="onClickHome"
        ...
        <!-- Mobile Navigation -->
        <div v-if="isOpen" class="md:hidden px-4 pb-4 space-y-2 text-white">
            <NuxtLink
                to="/"
                @click="onClickHome"
